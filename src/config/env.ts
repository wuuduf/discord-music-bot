...
const envSchema = z.object({
  ...
  YTDLP_DIRECT_CACHE_ENABLED: booleanFromEnv.default(true),
  YTDLP_DIRECT_CACHE_TTL_MS: z.coerce.number().int().min(0).max(60 * 60 * 1000).default(10 * 60 * 1000),
  YTDLP_DIRECT_CACHE_MAX_ITEMS: z.coerce.number().int().min(1).max(500).default(100),
